...
from core.prompts.executive_persona import (
...
if TYPE_CHECKING:
    from core.memory.company_profile import CompanyProfile
...
def build_system_blocks(
    ...
    from core.departments.prompt_block import render_org_block

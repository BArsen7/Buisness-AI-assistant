...
if TYPE_CHECKING:
    from core.orchestrator.debug_events import DebugCollector
from core.agents.board_comms import BoardCommsAgent
from core.agents.finance import FinanceAgent
from core.agents.hr_talent import HRAgent
from core.agents.legal import LegalAgent
from core.agents.marketing import MarketingAgent
from core.agents.operations import OperationsAgent
from core.agents.product import ProductAgent
from core.agents.strategy import StrategyAgent
from core.agents.talent import TalentAgent
...
async def _retrieve_for_call(call: dict[str, str]) -> str:
    ...
    from core.knowledge.retriever import retrieve
...
async def _retrieve_failures_for_call(call: dict[str, str]) -> str:
    ...
    from core.knowledge.retriever import retrieve_failures
...
async def _prefetch_department_for_call(
    ...
    """
    from core.departments.registry import slug_for_specialist
    from core.memory.honcho_client import prefetch_department

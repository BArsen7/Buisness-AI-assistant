...
- **Мультиагентная архитектура**: 9 специализированных ролей с расшифровкой на русском языке
...
### 📋 Доступные роли агентов

| Роль | Расшифровка | Описание |
|------|-------------|----------|
| 🎯 ORCHESTRATOR | Координатор | Главный управляющий агент, синтезирует мнения всех экспертов |
| 📊 CSO | Директор по стратегии | Долгосрочное планирование, конкурентный анализ |
| 💰 CFO | Финансовый директор | Финансы, юнит-экономика, рентабельность |
| 👥 CHRO | Директор по персоналу | Организационная структура, таланты, культура |
| ⚖️ GC | Генеральный counsel | Юридические вопросы, комплаенс, контракты |
| ⚙️ COO | Операционный директор | Процессы, эффективность, масштабирование |
| 📢 CMO | Директор по маркетингу | Позиционирование, клиентский опыт, бренд |
| 📱 CPO | Директор по продукту | Продуктовая стратегия, roadmap, метрики |
| 🏦 BOARD | Представитель инвесторов | ROI, оценка компании, exit-стратегия |
